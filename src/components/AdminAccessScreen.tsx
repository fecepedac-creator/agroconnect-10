  ...
  return (
    <div className="min-h-screen bg-[#080b12] text-white">
      <header className="mx-auto flex min-h-20 max-w-5xl items-center px-5 lg:px-8">
        <button onClick={() => window.location.assign("/")} className="flex min-h-11 items-center gap-2 text-sm font-bold text-white/80 hover:text-white"><ArrowLeft size={18} /> Volver</button>
      </header>
      <main id="main-content" tabIndex={-1} className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-5xl items-center justify-center px-5 pb-20 lg:px-8">
        <section className="w-full max-w-md rounded-[2rem] border border-white/10 bg-white/[0.04] p-7 shadow-2xl sm:p-10">
          ...
          <p className="mt-4 font-medium leading-relaxed text-white/80">Área exclusiva para SuperAdmin. Todos los intentos y acciones administrativas pueden ser auditados.</p>
          ...
          <p className="mt-5 text-center text-sm font-semibold leading-relaxed text-white/75">Conocer esta dirección no concede acceso. Los permisos se validan en Firebase Auth y nuevamente en el servidor.</p>
        </section>
      </main>
    </div>
  );
